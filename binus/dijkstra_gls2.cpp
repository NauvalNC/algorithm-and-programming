...
{	
    ...
    while(1) 
    {
		...
		printf("Current visited vertex: %c\n", idxtoa(s_idx));
		printf("Vertex adjacent to %c\n", idxtoa(s_idx));
	    printf("=====================\n");
	    printf("+--------+------+------+-------------------+\n");
        ...
        for (int i = 0; i < verts[s_idx]->c_adj; i++) 
        {
            ...
            printf("| %-6c | %-4d | %-4c | %-17d |\n", idxtoa(adj), w_path[adj] - w_path[f_path[adj]], idxtoa(f_path[adj]), w_path[adj]);
		    printf("+--------+------+------+-------------------+\n");
        }
        printf("\n\n");
    ...
    printf("Final Result of Dijkstra Algorithm (from %c to all vertex)\n", idxtoa(vA));
    printf("=========================================================\n");
    printf("+--------+------+------+-------------------+\n");
    printf("| vertex | cost | from | total cost from %c |\n", idxtoa(vA));
    printf("+--------+------+------+-------------------+\n");
...
int main() 
{
	printf("Djikstra Algorithm Simulation\n");
	printf("=============================\n\n");
